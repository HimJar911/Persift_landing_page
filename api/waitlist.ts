...
const DISPOSABLE_DOMAINS = new Set([
  ...
  "mailexpire.com","throwam.com","jetable.org","nospamfor.us","spam.la","tempinbox.com",
  "tempinbox.co.uk","tempr.email","discard.email","filzmail.com","tempomail.fr","boxtemp.com.br",
  "throwam.info","wegwerfmail.de","wegwerfmail.net","wegwerfmail.org","getnada.com","binkmail.com",
...
export default async function handler(req: VercelRequest, res: VercelResponse) {
  ...
  const body = req.body as { email?: string; ref?: string; website?: string }
  ...
  if (inboundRef && inboundRef !== refCode) {
    ...
    if (referrerEmail && referrerEmail !== email) {
      ...
      resend.emails.send({
        headers: {
          "X-Entity-Ref-ID": `referral-${email}`,
...
<body style="margin:0;padding:0;background:#0c0a08;">
  <span style="display:none;max-height:0;overflow:hidden;">Someone used your Persift referral link — you've moved up the queue.</span>
  ...
  <table width="100%" cellpadding="0" cellspacing="0" style="background:#0c0a08;padding:48px 24px;">
    <tr><td align="center">
      <table width="100%" cellpadding="0" cellspacing="0" style="max-width:480px;">
        ...
        <tr><td style="padding-bottom:32px;">
          <p style="margin:0;font-family:Inter,sans-serif;font-size:15px;color:rgba(243,236,225,0.8);line-height:1.7;">
            Persift is a Chrome extension that finds early-career roles before they hit LinkedIn — tailors your resume to each one and submits automatically. You apply to hundreds while you focus on what matters.
          </p>
          <p style="margin:16px 0 0;font-family:Inter,sans-serif;font-size:15px;color:rgba(243,236,225,0.8);line-height:1.7;">
            I'll reach out personally when the private beta opens.
          </p>
        </td></tr>
        ...
        <tr><td style="padding-bottom:48px;">
          <p style="margin:0;font-family:Inter,sans-serif;font-size:15px;font-weight:600;color:rgba(243,236,225,0.85);">
            Himanshu, founder of Persift
          </p>
        </td></tr>

        <tr><td>
          <p style="margin:0;font-family:Inter,sans-serif;font-size:13px;color:rgba(243,236,225,0.5);line-height:1.6;">
            You're receiving this because you signed up at <a href="https://persift.com" style="color:rgba(243,236,225,0.5);">persift.com</a>.<br>
